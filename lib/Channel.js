...
(function() {
  var Async, Channel, ConsumeParameters, Consumer, Message, createIncomingMessage, getOptionsForConsume, getOptionsForPublish, _ref,
  ...
  getOptionsForConsume = function(params) {
    return {
      noAck: params.noAck,
  ...
  Channel = (function() {
    ...
    Channel.prototype.consume = function(params, callback) {
      var channel, consumer, options, proxyMessage, queue;
      if (params == null) {
        params = {};
      }
      channel = this;
